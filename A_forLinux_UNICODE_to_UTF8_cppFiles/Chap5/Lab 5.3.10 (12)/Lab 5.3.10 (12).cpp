// Lab 5.3.10 (12).cpp : Defines the entry point for the console application.
//
...
Sheep::Sheep(double weight) : FarmAnimal((weight / 10.0) * 1.1) {}
...
Horse::Horse(double weight) : FarmAnimal((weight / 100.0) * 6.8) {}
...
Cow::Cow(double weight) : FarmAnimal((weight / 100.0) * 8.6) {}
